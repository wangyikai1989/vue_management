  ...
  <div class="qf-good-list">
    ...
    <div style="margin:25px 0">
      <el-row align="middle" type="flex">
        ...
        <el-col :span="4">
          <el-input v-model="filter.searchText" size="mini" @change='textFilter'></el-input>
        </el-col>
        <el-col :span="2" :offset="1">
          <div class="qf-filter-label">品类筛选:</div>
        </el-col>
        <el-col :span="4">
          <CateSelect v-model="filter.cate" @change="cateFilter" clearable size='mini'></CateSelect>
        </el-col>
